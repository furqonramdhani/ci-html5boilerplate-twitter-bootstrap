...
Ext.onReady(function () {
    ...
    var storeChart = Ext.create('Ext.data.JsonStore', {
        ...
        proxy: {
            type: 'ajax',
            url: base_url+'/index.php/interface/location/json_report_type10_per_category?year='+yearName+'&month='+monthName,
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var storeChart2 = Ext.create('Ext.data.JsonStore', {
        ...
        proxy: {
            type: 'ajax',
            url: base_url+'/index.php/interface/location/json_report_type10_per_subcategory?year='+yearName+'&month='+monthName,
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var storeChart3 = Ext.create('Ext.data.JsonStore', {
        ...
        proxy: {
            type: 'ajax',
            url: base_url+'/index.php/interface/location/json_report_type10_per_district?year='+yearName+'&month='+monthName,
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var panelChart = Ext.create('widget.panel', {
        width: '100%',
        height: 400,
        title: 'Level or compliance (if minimum 6 criteria included)',
        renderTo: 'chart-1',
        layout: 'fit',
        style:'font-size:8px;',
        tbar: [{
