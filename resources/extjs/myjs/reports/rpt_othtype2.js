...
Ext.onReady(function () {
    ...
    var storeChart = Ext.create('Ext.data.JsonStore', {
        ...
        proxy: {
            type: 'ajax',
            url: base_url+'/index.php/interface/location/json_report_type2_per_category?year='+yearName+'&month='+monthName,
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var storeChart2 = Ext.create('Ext.data.JsonStore', {
        ...
        proxy: {
            type: 'ajax',
            url: base_url+'/index.php/interface/location/json_report_type2_per_subcategory?year='+yearName+'&month='+monthName,
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var storeChart3 = Ext.create('Ext.data.JsonStore', {
        ...
        proxy: {
            type: 'ajax',
            url: base_url+'/index.php/interface/location/json_report_type2_per_district?year='+yearName+'&month='+monthName,
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var panelChart = Ext.create('widget.panel', {
        width: '100%',
        height: 400,
        title: 'Jumlah ditemukannya tempat khusus merokok didalam gedung  per Kategori',
        renderTo: 'chart-1',
        layout: 'fit',
        style:'font-size:8px;',
        tbar: [{
    ...
    var panelChart3 = Ext.create('widget.panel', {
        ...
        height: 400,
        autoSize:true,
        title: 'Jumlah ditemukannya tempat khusus merokok didalam gedung  per Sub Kategori',
        renderTo: 'chart-2',
        layout: 'fit',
        tbar: [{
            text: 'Save Chart',
    ...
    var panelChart4 = Ext.create('widget.panel', {
        ...
        height: 400,
        autoSize:true,
        title: 'Jumlah ditemukannya tempat khusus merokok didalam gedung  per Wilayah',
        renderTo: 'chart-2',
        layout: 'fit',
        tbar: [{
            text: 'Save Chart',
