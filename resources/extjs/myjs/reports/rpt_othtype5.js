...
Ext.onReady(function () {
    ...
    var storeChart = Ext.create('Ext.data.JsonStore', {
        ...
        proxy: {
            type: 'ajax',
            url: base_url+'/index.php/interface/location/json_report_type5_per_category?year='+yearName+'&month='+monthName,
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var storeChart2 = Ext.create('Ext.data.JsonStore', {
        ...
        proxy: {
            type: 'ajax',
            url: base_url+'/index.php/interface/location/json_report_type5_per_subcategory?year='+yearName+'&month='+monthName,
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var storeChart3 = Ext.create('Ext.data.JsonStore', {
        ...
        proxy: {
            type: 'ajax',
            url: base_url+'/index.php/interface/location/json_report_type5_per_district?year='+yearName+'&month='+monthName,
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var panelChart = Ext.create('widget.panel', {
        width: '100%',
        height: 400,
        title: 'Jumlah ditemukannya asbak didalam tempat/gedung per Kategori',
        renderTo: 'chart-1',
        layout: 'fit',
        style:'font-size:8px;',
        tbar: [{
    ...
    var panelChart2 = Ext.create('widget.panel', {
        ...
        height: 400,
        autoSize:true,
        title: 'Jumlah ditemukannya asbak didalam tempat/gedung per Kategori in Percent',
        renderTo: 'chart-2',
        layout: 'fit',
        tbar: [{
            text: 'Save Chart',
    ...
    var panelChart3 = Ext.create('widget.panel', {
        ...
        height: 400,
        autoSize:true,
        title: 'Jumlah ditemukannya asbak didalam tempat/gedung per Sub Kategori in Percent',
        renderTo: 'chart-2',
        layout: 'fit',
        tbar: [{
            text: 'Save Chart',
    ...
    var panelChart4 = Ext.create('widget.panel', {
        ...
        height: 400,
        autoSize:true,
        title: 'Jumlah ditemukannya asbak didalam tempat/gedung per Wilayah in Percent',
        renderTo: 'chart-2',
        layout: 'fit',
        tbar: [{
            text: 'Save Chart',
...
//                }
    ...
    var grid2 = Ext.create('Ext.grid.Panel', {
        store: storeChart2,
        width: '300',
        title: 'Jumlah ditemukannya asbak didalam tempat/gedung per Sub Kategori',
        loadMask: true,
        renderTo: 'gridReport',
...
//                }
    ...
    var grid3 = Ext.create('Ext.grid.Panel', {
        store: storeChart3,
        width: '300',
        title: 'Jumlah ditemukannya asbak didalam tempat/gedung per Wilayah',
        loadMask: true,
        renderTo: 'gridReport',
