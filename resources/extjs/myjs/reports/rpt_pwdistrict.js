...
Ext.onReady(function () {
    ...
    var storeChart = Ext.create('Ext.data.JsonStore', {
        ...
        proxy: {
            type: 'ajax',
            url: base_url+'/index.php/interface/location/json_group_location_per_district?year='+yearName+'&month='+monthName,
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var panelChart = Ext.create('widget.panel', {
        width: '100%',
        height: 400,
        title: 'Jumlah Pengawasan per Wilayah',
        renderTo: 'chart-1',
        layout: 'fit',
        tbar: [{
            text: 'Save Chart',
            ...
            series: [{
                ...
                tips: {
                    ...
                    renderer: function(storeItem, item) {
                        ...
                        this.update('Total Pengawasan : '+ storeItem.get('total_pengawasan'));
                    }
                },
                label: {
                    display: 'insideEnd',
                    field: ['total_pengawasan'],
    ...
    var panelChart2 = Ext.create('widget.panel', {
        ...
        items: {
            ...
            axes: [{
                type: 'Numeric',
                position: 'left',
                fields: ['total_pengawasan_percent'],
                title: 'Total',
                grid: true,
                minimum: 0,
                maximum: 100
            ...
            series: [{
                ...
                // gutter: 80,
                xField: 'building_city',
                yField: ['total_pengawasan_percent'],
                highlight: true,
                tips: {
                    trackMouse: true,
                    width: 180,
                ...
                label: {
                    display: 'outside',
                    field: ['total_pengawasan_percent'],
