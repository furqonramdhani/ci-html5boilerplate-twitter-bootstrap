...
Ext.Loader.setPath('Ext.ux', 'http://localhost/GitHub/ci-html5boilerplate-twitter-bootstrap/resources/extjs/ux');
Ext.require([
    'Ext.grid.*',
    'Ext.data.*',
    'Ext.panel.*',
...
Ext.onReady(function(){
    ...
    var store = Ext.create('Ext.data.JsonStore', {
        ...
        proxy: {
            type: 'ajax',
            url: 'http://localhost/repo/sfj/index.php/interface/category/json_listing_category',
            reader: {
                type: 'json',
                root: 'data'
            }
