...
Ext.onReady(function(){
    ...
    master.getForm().load({url:'/transaction/cashbank_ap/get_mscashbank/'+urlHalves[6], waitMsg:'Wait...'});
	...
	store = new Ext.data.Store({
		...
		proxy: new Ext.data.HttpProxy({
			url: '/transaction/cashbank_ap/json_listing_dtcashbank/'+urlHalves[6]
		}),
