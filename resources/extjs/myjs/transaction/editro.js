...
Ext.onReady(function(){
    ...
    var master = new Ext.FormPanel({
		...
		reader: new Ext.data.JsonReader (
		{
			...
			[
				...
				{name: 'pm', type: 'string', mapping: 'payment_method'},
				{name: 'pt', type: 'string', mapping: 'payment_type'},
    ...
    master.getForm().load({url:'/transaction/receive_order/get_msro/'+urlHalves[6], waitMsg:'Wait...'});
	...
	store = new Ext.data.Store({
		...
		proxy: new Ext.data.HttpProxy({
			url: '/transaction/receive_order/json_listing_dtro/'+urlHalves[6]
		}),
		...
		reader: new Ext.data.JsonReader({
			...
			{name: 'delivery_date', mapping:'delivery_date', type: 'date', dateFormat: 'Y-m-d'}
		])
	});
