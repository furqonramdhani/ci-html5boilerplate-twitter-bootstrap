...
Ext.onReady(function(){
    ...
    var master = new Ext.FormPanel({
		...
		reader: new Ext.data.JsonReader (
		{
			...
			[
				...
				{name: 'keterangan_kode', type: 'string', mapping: 'keterangan_kode'},
				{name: 'tglfaktur', type: 'string', mapping: 'tglfaktur'},
				{name: 'reff_inv', type: 'string', mapping: 'reff_inv'},
				{name: 'fkplg', type: 'string', mapping: 'fkplg'},
				...
				{name: 'no_mobil', type: 'string', mapping: 'no_mobil'},
				{name: 'nm_sopir', type: 'string', mapping: 'nm_sopir'}
			]
		}),
        items: [{
			layout:'column',
    ...
    master.getForm().load({url:'/transaction/invoice/get_msinvoice/'+urlHalves[6], waitMsg:'Wait...'});
	...
	store = new Ext.data.Store({
		...
		proxy: new Ext.data.HttpProxy({
			url: '/transaction/invoice/json_listing_dtinvoice/'+urlHalves[6]
		}),
		baseParams:{
			task: "LISTING"
		},
